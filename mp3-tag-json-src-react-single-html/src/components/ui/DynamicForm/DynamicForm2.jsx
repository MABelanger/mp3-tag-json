...
export const DynamicForm = (props) => {
  ...
  // 1. PRINCIPLE IMPLEMENTATION: Watch all form fields globally
  const formValues = useFormmethods.watch();

  // 2. PRINCIPLE IMPLEMENTATION: Listen for modifications and emit them upstream via props
  useEffect(() => {
    if (props.onChange) {
      props.onChange(formValues);
    }
  }, [formValues, props.onChange]);
